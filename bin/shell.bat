...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.console${project.version}\org.apache.karaf.shell.console-2.4.0.redhat-630157.jar
set CLASSPATH=%CLASSPATH%;%KARAF_HOME%\system\org\ops4j\pax\logging\pax-logging-api${pax.logging.version}\pax-logging-api-1.8.5.jar
